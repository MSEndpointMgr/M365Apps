...
.EXAMPLE
    ...
    If you want to cleanup OEM Based Office: InstallM365Apps.ps1 -XMLURL "https://mydomain.com/xmlfile.xml" -CleanOEM
...
.NOTES
    ...
    Version history:
        ...
        1.3.1 - (2023-06-21) Remove detection of Autopilot and ESP, because this script is for reinstalling Office.
#>
#region parameters
[CmdletBinding()]
Param (

<#
.SYNOPSIS
  Script to install Project as a Win32 App during Autopilot

.DESCRIPTION
    Script to install Project as a Win32 App during Autopilot by downloading the latest Office Deployment Toolkit
...
#Initate Install
Write-LogEntry -Value "Initiating Project setup process" -Severity 1
...
Write-LogEntry -Value "Project setup completed" -Severity 1
